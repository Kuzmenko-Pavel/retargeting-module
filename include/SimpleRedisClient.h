...
public:
    ...
    bool zadd(const std::string &key, int score, long member);
    bool set(const std::string &key, const std::string & member);
    bool setex(const std::string &key, const std::string & member, int seconds);
protected:
